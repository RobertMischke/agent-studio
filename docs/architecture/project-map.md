...
> Snapshot `pg-import-20260713215326359` (previous: `none`); source `snapshot-import`; history `docs/architecture/project-map-history/2026-07-13T22-32-53-484Z.json`.
...
Each documentation command atomically replaces `docs/architecture/project-map.md` and appends a dated JSON provenance envelope under `docs/architecture/project-map-history`.
