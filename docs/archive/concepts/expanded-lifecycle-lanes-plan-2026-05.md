...
> **Archived on 2026-07-29:** the “not implemented” premise is obsolete. Use
> the [Tasks domain map](../../system/domains/tasks.md) for current lane and
...
- An update to `docs/system/contracts/agent-task.md` if the task changes what agents can do (it should not for any of the listed tasks).
