...
> **Archived on 2026-07-29:** this measurement predates the multi-context chat
> implementation. Use
> [Orchestrator Chat](../../concepts/orchestrator-chat.md) and
> [Multichat Orchestrator](../../concepts/multichat-orchestrator.md) for the
> current design.
