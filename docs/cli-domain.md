...
- [docs/supported-clis.md](supported-clis.md) defines the cross-CLI invocation
  contract.
...
- [docs/cli-startup-cost-analysis-2026-05-09.md](cli-startup-cost-analysis-2026-05-09.md)
  is the spawn/probe/discovery cost analysis.
- [docs/codex-runner-investigation.md](codex-runner-investigation.md) records
