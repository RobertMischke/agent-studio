...
related-adrs: []
related-docs:
  - "docs/token-aggregation.md"
  - "docs/token-pricing.md"
...
> token domain doc: [`docs/token-aggregation.md`](../../token-aggregation.md).
...
`token-aggregation-canonical` in [`docs/code-patterns.md`](../../code-patterns.md)
...
- **Token domain doc (system of record):**
  [`docs/token-aggregation.md`](../../token-aggregation.md) holds the full audit,
...
- **Pricing:** [`docs/token-pricing.md`](../../token-pricing.md) owns the
...
- **Bus:** [`docs/agent-message-bus.md`](../../agent-message-bus.md) describes the
