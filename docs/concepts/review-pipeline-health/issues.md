...
| delivered | AGT-2229 replacement line / AGT-2262 | Canonical Remote Review claims tool gates and aspects under ReviewAttempt lease/fence authority. The direct SSH bridge, host semaphore, `gate-work` convention, and alias-based activity projection are removed. | [decision history](decision-history.md) |
...
| delivered | AGT-2222 T1+T2 | Derived admission, LLM budget, latency metric, and the historical SSH throughput bridge. AGT-2262 removed that bridge after canonical Remote Review replaced it. | [decision history](decision-history.md) |
