...
Project-level surface. Defines the ordered pre- and post-steps for one project. Reached from the project Settings panel (a new "Pipeline" section). Spec: [ADR-0051 section 5.1](../../system/architecture/decisions/proposed/adr-0051-task-processing-pipeline.md#51-project-level-the-pipeline-editor).
...
Operator types a description; the assistant proposes a draft definition the operator confirms (never auto-applied). The proposal is a schema-validated draft ([ADR-0032](../../system/architecture/decisions/adr-archive.md#adr-0032)).
