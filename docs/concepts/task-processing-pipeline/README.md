...
Concept-stage UX mockups for [ADR-0051](../../system/architecture/decisions/proposed/adr-0051-task-processing-pipeline.md). Two surfaces:
...
- Editor mutations are optimistic ([ADR-0046](../../system/architecture/decisions/adr-archive.md#adr-0046)).
