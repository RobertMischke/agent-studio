...
| [platform-architecture/README.md](platform-architecture/README.md) | Index of the durable execution and delivery architecture extracted from decision dossiers: fencing and leases, integration invariants, Task Server topology, Batch Gate, telemetry layer. Each page links back to its source dossier. | [`docs/system/domains/runner.md`](../system/domains/runner.md), [`docs/system/domains/tasks.md`](../system/domains/tasks.md) |
