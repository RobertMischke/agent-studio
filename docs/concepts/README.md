...
|---|---|---|
| [platform-architecture/](platform-architecture/README.md) | Durable execution and delivery architecture extracted from decision dossiers: fencing/leases/authority, rebase/merge/promotion invariants, Task Server gate topology, Batch Gate, and the telemetry-layer proposal. | [`docs/system/domains/runner.md`](../system/domains/runner.md), [`docs/system/domains/tasks.md`](../system/domains/tasks.md), [`docs/system/domains/pipeline.md`](../system/domains/pipeline.md) |
