---
id: evidence-gate
title: "Auto-review evidence gate"
concept-page: docs/concepts/auto-review-evidence-gate-analysis.html
...
# Designated topic: Auto-review evidence gate
...
> [`docs/concepts/auto-review-evidence-gate-analysis.html`](../auto-review-evidence-gate-analysis.html). Add narrative to the concept page itself; the progress table
