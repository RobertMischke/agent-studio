...
This folder is the **second-look** for any visual or styling change. The first stop is still [`docs/design-system.md`](../design-system.md) (the "why" of the shell: Material 3 mapping, color philosophy, type ramp, motion grammar). The style guide is the **"what to grab"** for a concrete change:
