...
| [ui-tooltip-audit.md](ui-tooltip-audit.md) | Canonical `[appTooltip]` directive contract, usage examples, migration audit, and drift rule for banning native browser title tooltips. |
...
| [research/escalated-lane-and-decision-surface-2026-06.md](research/escalated-lane-and-decision-surface-2026-06.md) | Separate "needs my decision" (escalate) from "ready to accept" in `5-human-review`, add a 4-action decision surface, an escalation-rate metric/alarm, and accept-leaning aspect prompts. Surfaces the folder-lane-vs-phase-substate fork that must be decided before code. Grounding for ASS-1652. |
| [research/agent-eval-set-split-measurement-2026-06.md](research/agent-eval-set-split-measurement-2026-06.md) | Small internal eval-set skeleton for measuring monolithic agent context versus domain-split context on typical taskboard coding tasks. |
