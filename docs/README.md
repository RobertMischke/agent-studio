...
| Solution workspace, sibling component projects, repository bindings, cross-project Initiatives, and explicit board scopes | [concepts/solution-workspace-component-project-model.md](concepts/solution-workspace-component-project-model.md) |
