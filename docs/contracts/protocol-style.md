...
See [docs/cli/supported-clis.md §2.5](../cli/supported-clis.md) for the per-CLI translation rules.
...
2. If you change the **marker-line vocabulary**, update §2.1 here and the corresponding row in [docs/cli/supported-clis.md §2.5](../cli/supported-clis.md).
