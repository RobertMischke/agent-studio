...
| [demo-replay-trace.md](demo-replay-trace.md) | Public-demo replay plane: signed fixed trace, canonical digest, narrow ingestion scope, and the exclusive `demo.replay` credential. |
