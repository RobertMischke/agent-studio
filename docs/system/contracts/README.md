...
| [quality-studio-analysis.md](quality-studio-analysis.md) | Standard Quality Studio analysis axes, repository-owned policy, in-process package boundary, evidence, and retry semantics. |
