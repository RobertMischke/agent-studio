...
- The Execution Hosts destination at `#/workspace/settings/execution-hosts`
  ...
  text-only overflow menu. A persisted machine disclosure keeps identity,
  connection, capability, authentication, capacity, lease, and telemetry
  internals out of the primary operator scan path.
