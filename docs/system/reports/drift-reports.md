...
| `Architecture` | Does the source tree match the ADRs and the architecture model? | `docs/system/architecture/decisions/adr-archive.md`, `docs/system/architecture/model.md`, the architecture-model frontmatter, source tree, dependency graph. |
