...
| `Architecture` | Does the source tree match the ADRs and the architecture model? | `docs/architecture/decisions/adr-archive.md`, `docs/architecture/model.md`, the architecture-model frontmatter, source tree, dependency graph. |
...
| `Process` | Does how work actually flows match the documented process? | `docs/contracts/agent-task.md`, `docs/product/skills-architecture.md`, `docs/operations/git/commit-push-doctrine.md`, `AGENTS.md` workflow sections, recurring blocked reasons. |
