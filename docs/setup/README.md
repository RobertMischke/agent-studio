...
- [../skills-architecture.md](../skills-architecture.md) - portable-skills doctrine (the `.agents/skills/` library).
...
- [../agent-task-contract.md](../agent-task-contract.md) - the app-owned task lifecycle every watched project inherits.
