...
- The local mockup comparison already records VS Code/Copilot as the density and peripheral-status reference: [docs/mockups/chat-window-next-gen/best-practices-comparison.md](../mockups/chat-window-next-gen/best-practices-comparison.md).
