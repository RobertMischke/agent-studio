...
- Use [docs/run-outcome-contract.md](run-outcome-contract.md) for the shared
  classification that drives lane routing, `status.md`, and frontend failure
  surfacing.
- Use [docs/agent-task-contract.md](agent-task-contract.md) for the boundary
...
- Use [docs/research/orchestrator-decision-protocol-2026-05.md](research/orchestrator-decision-protocol-2026-05.md)
  and [docs/architecture-decisions.md](architecture-decisions.md) for ADR-0002
...
- Sentinel matches are authoritative. When adding a sentinel, update
  [docs/agent-task-contract.md](agent-task-contract.md) and
