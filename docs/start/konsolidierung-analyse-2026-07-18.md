...
Empfehlung: eine einzige "Wiki-System"-Übersichtszeile in `docs/start/README.md` bzw. der neuen
...
Die Grundstruktur nach der Migration 2026-06-11 ist gesund (Kategorien = Ordner, `docs/start/README.md` als Index). **Kein großer Umbau.** Empfohlen ist genau eine neue Ebene und wenige Moves:
...
kein Commit. Diese Datei (`docs/start/konsolidierung-analyse-2026-07-18.md`) ist die einzige
