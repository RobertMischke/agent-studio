...
| claude CLI not available right after an auto-update | [common-problems/claude-native-launcher-stub/](../operations/common-problems/claude-native-launcher-stub/) |
