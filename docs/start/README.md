...
| Rebase, merge, and bounce steering (attribution lens, current hybrid, Batch Gate interaction, and bounded automation scenarios) | [decision dossier](../operations/rebase-merge-and-steering/index.html) |
