...
| Windows control-plane host (guided tunnel keeper/watchdog registration, elevation-consent flow, admin-UI visibility) | [operations/setup/windows-control-plane-host.md](../operations/setup/windows-control-plane-host.md) |
