...
| Public read-only demo edge (public-demo profile, endpoint allowlist, typed denials) | [operations/setup/public-demo-edge.md](../operations/setup/public-demo-edge.md) |
