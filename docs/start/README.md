...
| Deployment regression scenario for in-process, Compose, and remote release targets | [operations/testing/deployment-scenario.md](../operations/testing/deployment-scenario.md) |
