...
| Admin surface design living standard: flat composition, visual Dos and Don'ts, applied-surface register, light/dark Activity reference, and incremental adoption (AGT-W1) | [living Dossier](../operations/admin-design-guideline/index.html) · [Dos and Don'ts](../operations/admin-design-guideline/pages/dos-and-donts.html) · [Applied surfaces](../operations/admin-design-guideline/pages/applied-surfaces.html) |
