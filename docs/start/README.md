...
| Rebase, merge, and bounce steering decision dossier: attribution boundaries, stage-specific Git choices, Batch Gate interaction, and bounded platform/guardian requeue ownership (AGT-2662) | [decision dossier](../operations/rebase-merge-and-steering/index.html) |
