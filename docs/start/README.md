...
| Local telemetry layer across organization apps: current signals, event model, no-cloud bus options, Watcher consumption, Agent Studio ops-hub boundaries, and Quality Studio pilot (AGT-2661) | [decision dossier](../operations/telemetry-layer/index.html) |
