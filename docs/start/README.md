...
| Organization telemetry layer decision dossier: current signals, Product Runtime Event profile, hybrid local bus, privacy, Watcher actions, Agent Studio operations hub, and Quality Studio pilot (AGT-2661) | [decision dossier](../operations/telemetry-layer/index.html) |
