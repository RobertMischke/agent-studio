...
| Article document authoring (`ui` / `concept` patterns, canonical v2 template, and migration policy) | [author guide](../operations/article-document-authoring.md) · [copyable template](../app/templates/article-document-v2.html) |
