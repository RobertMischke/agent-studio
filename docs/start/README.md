...
| Living admin surface design standard: flat composition, semantic color, accessible disclosure, restrained chips, compact density, visual dos and don'ts, and an append-only applied-surface register (AGT-W1) | [Dossier](../operations/admin-design-guideline/index.html) · [visual dos and don'ts](../operations/admin-design-guideline/pages/dos-and-donts.html) · [applied surfaces](../operations/admin-design-guideline/pages/applied-surfaces.html) |
