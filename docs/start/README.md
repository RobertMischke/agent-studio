...
| Escalation view information architecture: one blocker summary in the header, step-only Pipeline state, flat Result rows, real Stable evidence, and implementation slices (AGT-2643) | [decision dossier](../operations/escalation-view-information-architecture/index.html) |
