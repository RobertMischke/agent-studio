...
| Local-first telemetry layer across organization applications: event model, hybrid file and local-push bus, privacy, orchestrator actions, Agent Studio operations hub, and Quality Studio pilot (AGT-2661) | [decision dossier](../operations/telemetry-layer/index.html) |
