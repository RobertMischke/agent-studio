...
| Retention and archive policy: artifact classes, staged thinning, cold manifests, restore, and full backups (AGT-2743) | [decision dossier](../operations/retention-und-archiv/index.html) · [Retention CLI](../operations/setup/task-server.md#retention-cli) |
