...
| Public name for the living document across exploration, decision, delivery tracking, and durable documentation (AGT-2584) | [decision dossier](../operations/living-document-naming/index.html) |
