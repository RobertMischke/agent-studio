...
| Windows control-plane host (guided tunnel keeper + watchdog setup and status) | [operations/setup/windows-control-plane-host.md](../operations/setup/windows-control-plane-host.md) |
