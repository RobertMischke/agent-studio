...
| Windows control-plane host: guided tunnel keeper/watchdog registration, elevation consent, and live status (AGT-2664) | [operations/setup/windows-control-plane-host.md](../operations/setup/windows-control-plane-host.md) |
