...
| Local-first telemetry layer across organization applications: current ledgers, normalized event and privacy model, hybrid bus, Watcher action rules, Agent Studio Ops Hub boundary, and Quality Studio reliability pilot (AGT-2661) | [decision dossier](../operations/telemetry-layer/index.html) |
