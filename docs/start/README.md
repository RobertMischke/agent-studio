...
| Admin surface design living standard: flat composition, semantic color, tooltips, chips, density, light/dark Activity reference, and incremental adoption (AGT-W1) | [standard](../operations/admin-design-guideline/index.html) · [Dos and Don'ts](../operations/admin-design-guideline/pages/dos-and-donts.html) · [Applied surfaces](../operations/admin-design-guideline/pages/applied-surfaces.html) |
