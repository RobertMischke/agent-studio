...
| Public demo replay plane: signed fixed trace schema, canonical digest, narrow ingestion scope, exclusive `demo.replay` credential, and the replay-service image boundary (AGT-2668, AGT-W34 slice S3) | [trace contract](../system/contracts/demo-replay-trace.md) |
