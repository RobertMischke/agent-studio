...
| Rebase, merge, and bounce steering: attribution-driven stage choices, Batch Gate compatibility, and bounded platform and guardian recovery (AGT-2662) | [decision dossier](../operations/rebase-merge-and-steering/index.html) |
