...
The existing roadmap focuses on reliable task execution, security, quality checks, and review evidence. This mockup adds a generative design dimension plus explicit testing, QA, and source-code perspectives:
