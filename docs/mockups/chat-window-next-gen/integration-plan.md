...
| Angular clickware prototype | `frontend/src/mockups/next-gen-chat/app/`, `npm run mockup:chat` | Standalone interactive shell for reviewing tall workbench layout, optional queue module, task rail, document tabs, side sheet, Git/source split, light/dark, density, debug, and mobile collapse |
