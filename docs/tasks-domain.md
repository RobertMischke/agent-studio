...
- [docs/filesystem-contract.md](filesystem-contract.md) defines the durable
  job-folder layout, lane catalog, and state strings.
- [docs/agent-task-contract.md](agent-task-contract.md) defines what the app
  owns and what the CLI owns inside a task.
- [docs/protocol-style.md](protocol-style.md) covers `status.md`, Activity Log
  markers, `attachments/`, `results/`, and image retention.
- [docs/architecture-3-progress-lane-writers.md](architecture-3-progress-lane-writers.md)
