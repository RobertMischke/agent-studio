...
3. If you add a new **task evidence integration**, update §6 and reconcile with [`docs/protocol-style.md`](protocol-style.md) so the protocol pane and the screenshot strip stay consistent.
