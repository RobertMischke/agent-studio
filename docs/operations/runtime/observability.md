...
>
> **Schema home:** the field-level rules live in [`docs/app/schemas/product-runtime-event.schema.json`](../../app/schemas/product-runtime-event.schema.json). This file is the prose contract; the schema is the validator.
...
| Schema | [`agent-message.schema.json`](../../app/schemas/agent-message.schema.json) | [`product-runtime-event.schema.json`](../../app/schemas/product-runtime-event.schema.json) |
...
Every runtime event is a small JSON document validated by [`product-runtime-event.schema.json`](../../app/schemas/product-runtime-event.schema.json). The required fields are deliberately minimal so producers can adopt the shape without ceremony:
...
1. If you change the **schema** in `docs/app/schemas/product-runtime-event.schema.json`, mirror the change in §4 of this file in the same PR.
