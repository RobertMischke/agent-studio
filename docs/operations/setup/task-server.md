...
task already exists, the installer stops it before repointing `current` and
the cutover probe rejects any restarted service whose reported Git SHA differs
