...
to publish from a checkout whose HEAD differs from `ReleaseSha`. It verifies
both a newly published binary and a reused release directory against that SHA.
