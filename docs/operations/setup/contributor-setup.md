...
This is the source-build path for contributors who need to edit, test, or debug
Agent Studio itself. It is not an installation path for product users. Product
users should follow the single Docker Compose path in
