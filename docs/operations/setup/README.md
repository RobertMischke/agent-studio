...
| [windows-control-plane-host.md](./windows-control-plane-host.md) | Product-managed Windows reverse-tunnel setup: guided UAC consent, installed keeper and watchdog Scheduled Tasks, status visibility, and fault verification. |
