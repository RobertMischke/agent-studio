...
| [windows-control-plane-host.md](./windows-control-plane-host.md) | Guided registration of the Windows tunnel keeper and watchdog (elevation-consent flow, status check, and admin-UI visibility) - the Windows-side sibling to linux-runner-host.md. |
