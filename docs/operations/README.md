...
| [rebase-merge-and-steering/](rebase-merge-and-steering/index.html) | Decision dossier on attribution-driven rebase versus merge choices across delivery, integration, Batch Gate, and promotion, plus a bounded migration from session-side bounce steering to a deterministic platform rail and targeted guardian retry (AGT-2662). |
