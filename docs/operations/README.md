...
| [workspace-repository-lifecycle.md](workspace-repository-lifecycle.md) | Task Repository durability policy, hourly drift sweep, catch-up push budget, staging size guard, Git maintenance defaults, and manual backlog recovery. |
