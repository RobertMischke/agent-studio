...
| [workspace-repository-lifecycle.md](workspace-repository-lifecycle.md) | Workspace commit scope, runtime exclusions, hourly drift sweep, Git maintenance, push catch-up, and manual backlog recovery. |
