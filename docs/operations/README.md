...
| [rebase-merge-and-steering/](rebase-merge-and-steering/index.html) | Decision dossier on rebase-first delivery repair, merge-first canonical integration, commit-attribution and candidate-SHA invariants, Batch Gate interplay, and bounded platform and guardian automation for bounce steers (AGT-2662). |
