...
| [admin-design-guideline/](admin-design-guideline/index.html) | Living design standard for flat, dense admin surfaces, with visual dos and don'ts, a light/dark Activity reference, an append-only Applied surfaces register, and incremental adoption (AGT-W1). |
