...
| [telemetry-layer/](telemetry-layer/index.html) | Decision dossier for a local-first telemetry layer across organization applications: current ledgers, event and privacy model, hybrid bus, Watcher consumption, Agent Studio Ops Hub boundary, and Quality Studio pilot (AGT-2661). |
