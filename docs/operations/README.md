...
| [escalation-view-information-architecture/](escalation-view-information-architecture/index.html) | Decision dossier for consolidating escalated task detail into one concrete blocker summary, one failed-step marker, and flat Result rows, with real Stable evidence and review-gated implementation slices (AGT-2643). |
