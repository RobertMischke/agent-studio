...
| [rebase-merge-and-steering/](rebase-merge-and-steering/index.html) | Decision dossier for stage-specific rebase and merge policy through the attribution lens, plus deterministic platform bounce steering, bounded guardian escalation, and Batch Gate interaction (AGT-2662). |
