...
| [telemetry-layer/](telemetry-layer/index.html) | Decision dossier for a local-first telemetry layer across organization applications, with a hybrid file and local-push bus, privacy boundaries, bounded orchestrator actions, Agent Studio operations-hub positioning, and a Quality Studio pilot (AGT-2661). |
