...
| [telemetry-layer/](telemetry-layer/index.html) | Decision-ready dossier for a local-first telemetry layer across organization apps: current inventory, shared event profile, hybrid file-first bus, privacy boundary, Watcher action rules, Agent Studio operations-hub positioning, and a Quality Studio pilot (AGT-2661). |
