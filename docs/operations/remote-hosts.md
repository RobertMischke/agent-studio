...
by each runner. Coding and Review on one machine appear as role sub-rows with
their own slot ceilings and actions. Load, activity, and release appear once on
