...
probes all pass for the exact candidate SHA; a failed candidate is not attached
to `main`. A retry of a held detached candidate reinstalls its Task Server
package before probing.
