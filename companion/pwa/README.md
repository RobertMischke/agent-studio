...
The contract it must satisfy lives in [`docs/product/companion-app-design.md`](../../docs/product/companion-app-design.md). [ADR-0018](../../docs/architecture/decisions/adr-archive.md) holds the architecture decision.
