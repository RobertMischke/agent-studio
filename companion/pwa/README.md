...
The contract it must satisfy lives in [`docs/concepts/companion-app-design.md`](../../docs/concepts/companion-app-design.md). [ADR-0018](../../docs/system/architecture/decisions/adr-archive.md) holds the architecture decision.
