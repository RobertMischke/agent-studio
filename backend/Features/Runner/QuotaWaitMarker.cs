...
public sealed record QuotaWaitRecord
{
    ...
    [JsonPropertyName("scope")] public string Scope { get; init; } = "quota";
}
...
public static class QuotaWaitMarker
{
    ...
    /// <summary>
    /// Deletes the marker file if present. Returns whether a file was
    /// actually deleted, so callers can skip a cache invalidation on a
    /// no-op clear.
    /// </summary>
