...
public partial class GenericCliExecutionService : ICliExecutionService
{
    ...
    /// <summary>
    /// Quality-first default for the code-review grade pass: latest Claude Opus.
    ...
    /// </summary>
    public static string DefaultOpusModel => ModelFamilyResolver.ResolveAvailable(ModelFamilies.ClaudeOpus);
