...
public sealed class AdHocUsageService
{
    ...
    private static void Add(Dictionary<string, Bucket> map, string key, AdHocUsageRecord r, TokenCostEstimate cost)
    {
        ...
        b.Cost += cost.Total;
        b.FirstRecordedAt = b.FirstRecordedAt is null || r.Ts < b.FirstRecordedAt ? r.Ts : b.FirstRecordedAt;
        b.LastRecordedAt = b.LastRecordedAt is null || r.Ts > b.LastRecordedAt ? r.Ts : b.LastRecordedAt;
    }
