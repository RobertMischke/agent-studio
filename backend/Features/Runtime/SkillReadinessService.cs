...
/// skill lookup section described in <c>docs/product/skills-architecture.md</c>
...
/// (per ADR-0005 / docs/product/skills-architecture.md "First Product Step").
///
...
public class SkillReadinessService
{
    ...
    /// snippet from <c>docs/product/skills-architecture.md</c> contains every
    ...
    public SkillReadinessReport? CheckProject(string projectName)
    {
        ...
        {
            status = SkillReadinessStatus.Fail;
            summary = "No skill lookup heading found in README, AGENTS, or the Copilot shim. Add the section described in docs/product/skills-architecture.md.";
        }
