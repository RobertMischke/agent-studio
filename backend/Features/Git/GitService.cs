...
public class GitService
{
    ...
    /// The newest Codex mini-family model for additive semantic review and commit-message text.
    /// <para>
        ...
        CommitGateResult? gate = null)
    {
        ...
        var model = ModelFamilyResolver.ResolveAvailable(ModelFamilies.GptMini);
