...
public class ClientIdentityStore
{
    ...
    private void TryWriteLocked(ClientIdentity record)
    {
        var dir = IdentitiesFolder;
        try
        {
        ...
        {
            _logger.LogError(ex, "Failed to write identity file for '{Id}'", record.Id);
        }
    }
}
