...
/// actually use. Bounded supporting steps use the latest Codex Mini/high; the
...
public static class PipelineStepModelDefaults
{
    ...
    public static string SupportModel => ModelFamilyResolver.ResolveAvailable(ModelFamilies.GptMini);
    public const string SupportThinkingLevel = "high";

    public static string QualityModel =>
        ModelFamilyResolver.ResolveAvailable(ModelFamilies.GptFlagship);
