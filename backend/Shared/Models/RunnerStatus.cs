...
public record RunnerStatus
{
    ...
    /// <summary>
    /// Active local control-plane CLI repair failures. Healthy providers take
    /// no response or UI space.
    /// </summary>
...
public sealed record LocalCliRepairStatus
{
    ...
    /// <summary>Currently <c>failed</c>; open for forward-compatible active states.</summary>
