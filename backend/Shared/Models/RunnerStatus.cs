...
public record RunnerStatus
{
    ...
    /// <summary>
    /// Active local control-plane CLI repair failures. Healthy and repaired
    /// providers are omitted so this projection reflects current operator work.
    /// </summary>
...
public sealed record LocalCliRepairStatus
{
    ...
    /// <summary>Currently <c>failed</c>; retained as a string for wire compatibility.</summary>
