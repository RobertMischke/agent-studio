...
/// tagged <c>integrationpending</c>, dropping the tag from any that have since
...
public record IntegrationPendingListing
{
    ...
    /// <summary>How many stale <c>integrationpending</c> tags were cleared this pass (now integrated).</summary>
