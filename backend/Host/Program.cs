...
builder.Services.AddSingleton<IScheduledTaskInspector, SchtasksScheduledTaskInspector>();
builder.Services.AddSingleton<IWatchdogLogReader, WatchdogLogReader>();
builder.Services.AddSingleton<IWindowsTunnelSupervisionService, WindowsTunnelSupervisionService>();
