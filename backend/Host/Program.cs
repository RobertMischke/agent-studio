...
builder.Services.AddSingleton<IWorkbenchDecisionRepository, WorkbenchDecisionRepository>();
builder.Services.AddSingleton<IWorkbenchDecisionTaskMutation, WorkbenchDecisionTaskMutation>();
