...
public class TokenSummaryTests
{
    ...
    [InlineData("support:legacy-reviewer", "task-token-receipt", TaskTokenUsageTypePolicy.ReviewRun)]
    [InlineData("orchestrator:Demo", "review-decision", TaskTokenUsageTypePolicy.Gate)]
    [InlineData("support:grade", "quality-grade", TaskTokenUsageTypePolicy.Gate)]
