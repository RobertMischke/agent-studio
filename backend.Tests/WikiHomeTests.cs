...
/// <c>docs/wiki/home.json</c> with per-link <c>exists</c> flags (dead links are
...
public class WikiHomeTests : IDisposable
{
    ...
    {
        WriteDoc("wiki/home.json", "{ this is not json ");
    ...
    /// <summary>
    /// The shipped seed (<c>docs/wiki/home.json</c> in this repository) must
