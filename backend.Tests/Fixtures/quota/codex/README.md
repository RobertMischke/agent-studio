...
`codex-status-v0.144.1.txt` and `codex-status-v0.149.0.txt` were captured on
2026-08-25. Version 0.149.0 adds the context-window row; both versions render
reset timestamps on continuation lines and may omit the standard 5-hour row.
