...
public sealed class WikiMaintenancePostStepRunnerTests : IDisposable
{
    ...
    public void Run_WithOutcomeIssue_CreatesProjectScopedCommonProblemAndIndex()
    {
        ...
        var problem = Path.Combine(projectRoot, "docs", "common-problems", "missing-terminal-sentinel");
        ...
        var index = File.ReadAllText(Path.Combine(projectRoot, "docs", "common-problems", "README.md"));
    ...
    public void Run_RepeatedSameTask_UpdatesLastSeenWithoutDuplicateOccurrence()
    {
        ...
        var problem = Path.Combine(projectRoot, "docs", "common-problems", "classifier-unknown");
        var readme = File.ReadAllText(Path.Combine(problem, "README.md"));
    ...
    private string PrepareProjectWiki()
    {
        ...
        Directory.CreateDirectory(Path.Combine(projectRoot, "docs", "common-problems"));
        return projectRoot;
    }
