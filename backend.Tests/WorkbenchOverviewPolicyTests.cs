...
public sealed class WorkbenchOverviewPolicyTests
{
    ...
    public void Sort_PrioritizesOpenDecisionCountThenActiveRecencyAndSeparatesHistory()
    {
        var items = new[]
        {
            ...
            Item("Project A", "living-standard", "living-standard", "2026-08-09T10:30:00Z"),
        ...
        Assert.Equal(
            ["pending-four", "pending-one", "active-new", "living-standard", "active-old", "decided", "archived", "documented"],
