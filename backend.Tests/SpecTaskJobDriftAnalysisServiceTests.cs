...
/// <summary>
/// Locks the contract of <see cref="SpecTaskJobDriftAnalysisService"/>:
...
/// </summary>
public class SpecTaskJobDriftAnalysisServiceTests : IDisposable
{
    private readonly string _projectRoot;
    private readonly string _repoRoot;

    public SpecTaskJobDriftAnalysisServiceTests()
    {
    ...
    public void SelectScope_PicksUpSpecsAndPlanningDocsAndSkipsMissingFiles()
    {
        ...
        var svc = new SpecTaskJobDriftAnalysisService();
    ...
    public void DetectDuplicateTaskCandidates_FlagsPairsWithHighTokenOverlapAndSkipsUnrelatedJobs()
    {
        var jobs = new[]
        {
            new SpecTaskJobDriftAnalysisService.ActiveJobRef(
        ...
        var pairs = SpecTaskJobDriftAnalysisService.DetectDuplicateTaskCandidates(jobs);
    ...
    {
        var none = SpecTaskJobDriftAnalysisService.DetectDuplicateTaskCandidates(
            Array.Empty<SpecTaskJobDriftAnalysisService.ActiveJobRef>());
        Assert.Empty(none);
    }
