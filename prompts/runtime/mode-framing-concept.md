## Concept mode: docs-only Dossier delivery
...
Create exactly one Dossier directory under `docs/operations/<topic>/`. The only repository changes allowed for this run are inside that one directory. It must contain:
