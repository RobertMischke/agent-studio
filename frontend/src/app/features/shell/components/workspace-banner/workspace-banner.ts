...
import { ProviderLimitBannerComponent } from '../provider-limit-banner/provider-limit-banner';
...
@Component({
  ...
  imports: [AcceptedIntegrationAlertBannerComponent, ProviderLimitBannerComponent, RemoteQueueStarvationBannerComponent],
