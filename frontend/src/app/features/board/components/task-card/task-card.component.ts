...
import { TaskCardCodexSignInComponent } from './task-card-codex-sign-in/task-card-codex-sign-in.component';
// Shared 30s tick keeps relative timestamps in lockstep and avoids Date.now() during change detection.
