...
const PIPELINE_KIND_EXPLANATIONS: Record<StepKind, string> = {
  ...
  analysis:     'An in-process Quality Studio analysis step that records named findings.',
...
const PIPELINE_PHASES: Record<PipelinePhaseKey, PipelinePhaseVm> = {
  ...
  analysis: {
    key: 'analysis',
    label: 'ANALYSIS',
    description: 'In-process Quality Studio checks that record named findings.',
  },
  aspect: {
    key: 'aspect',
    label: 'ASPECT',
