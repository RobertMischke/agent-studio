...
import { PRESENTED_TASK_STATES, laneName } from '../../../../models/lane-presentation.model';
...
/** Canonical kanban lane order from the shared presentation source. */
const LANE_ORDER: readonly string[] = PRESENTED_TASK_STATES;
