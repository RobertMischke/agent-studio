...
export interface ProtocolVerdict {
   ...
   * status.md (e.g. `4 min`). Surfaced as a compact stat in the Result header
   * instead of leaving the Status section in the rendered body. Null when
   * status.md has no Duration line yet.
   */
