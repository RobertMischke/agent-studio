 ...
 * for, top to bottom:
 *
 *   1. **metadata head** - the single emphasized outcome plus quiet grade /
 *      duration / tokens / commits values, so "is this fine and how big is
 *      it?" answers at a glance without a row of badges;
