...
describe('ProjectProposalsPanelComponent', () => {
  it('renders a proposal and spawns an implementation card on approval', async () => {
    ...
    const item = { id: 'survey-001', generation: '2026-07-11', finding: 'Navigation is clipped.', evidenceScreenshot: '2026-07-11/assets/001.png', proposal: 'Make navigation responsive.', estimatedEffort: 'medium', severity: 'critical', status: 'proposed', spawnedTask: null, relPath: '2026-07-11/survey-001.md', updatedAt: new Date().toISOString() };
