...
describe('CliUsageModalComponent', () => {
  ...
  it('does not double-count Codex cached input and hides zero-token ad-hoc rows', async () => {
    ...
    expect(component.modelCoverage()?.firstRecordedAt).toBe('2026-07-11T07:30:00.000Z');
    expect(component.modelCoverage()?.lastRecordedAt).toBe('2026-08-11T16:42:00.000Z');
    expect(component.modelCoverage()?.label).toContain('Since 11 Jul 2026 · as of 11 Aug 2026');
  });
