...
- `OrchestratorChatTurn`, `OrchestratorChatResponse` — chat surface.
...
- `coding-agent-chat` is consumed as an exact published registry version so Stable installs remain reproducible.
