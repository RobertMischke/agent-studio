...
- `OrchestratorConfigPanelComponent` — autonomy + flags configuration; opened from the dev-tools menu.
- `OrchestratorSideSheetComponent` — right-hand sidesheet that hosts the orchestrator chat + roadmap-intake tab + project-list tab.
