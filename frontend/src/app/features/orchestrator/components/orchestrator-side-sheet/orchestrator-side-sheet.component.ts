...
export class OrchestratorSideSheetComponent implements OnInit, OnDestroy {
  ...
  /** Canonical active-tab context used for chat scope and context suggestions. */
  ...
  /**
   * Synchronous active-tab task projection shared with the Add context picker.
   * It wins over the asynchronously hydrated detail inputs so the
