...
const ENTRIES: Record<ConceptKey, ConceptEntry> = {
  orchestrator: {
    ...
    body:
      ...
      'It owns task pickup, lifecycle transitions, and the post-run policy. The CLI agent reports its own outcome with sentinels like [[TASK_DONE]] or [[TASK_BLOCKED:...]]; the orchestrator treats those as one input among several and is the single arbiter that moves a task between lanes.\n\n' +
    ...
    learnMore: 'docs/system/architecture/decisions/adr-archive.md',
  ...
  skills: {
    ...
    learnMore: 'docs/concepts/skills-architecture.md',
