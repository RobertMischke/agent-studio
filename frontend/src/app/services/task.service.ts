...
import type { CliModelCatalog, CliCompletionContract, CliUsageReport, CliSessionDetail, CliSessionDeleteResult, CliWorkingMemoryReport, CliWorkingMemoryDeleteResult, LocalCliRepairSnapshot } from '../features/cli';
...
export class TaskService {
  ...
  getLocalCliRepairSnapshot() {
    return this.http.get<LocalCliRepairSnapshot>(`${this.baseUrl}/cli/local-capabilities`);
  }
