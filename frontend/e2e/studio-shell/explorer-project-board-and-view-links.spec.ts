 ...
 * four project-scoped links: "Board" (the kanban), "Project Hub", "Wiki",
 * and "Epics" (overview). The retired per-lane children (active /
...
test.describe('Explorer · project links to Board / Project Hub / Wiki / Epics', () => {
