    ...
    elements: [
      element('runner', 'Project runner', 45, 'High', 0.78, 'Tracked',
        'Runner state-machine has drifted from ADR-0024.', {
          ...
          evidenceRefs: ['docs/architecture/decisions/adr-archive.md#adr-0024', 'backend/Services/Jobs/JobTransitionService.cs:1'],
...
function plantDriftReport(dir: string, opts: { overall: number; band: string; elements: PlantedElement[] }): void {
  ...
  const record = {
    ...
    createdAt,
    trigger: 'Manual',
    scope: { kind: 'Project', sourceRefs: ['docs/architecture/decisions/adr-archive.md'] },
    ...
    dimensions: [
      {
        ...
        evidenceRefs: ['docs/architecture/decisions/adr-archive.md'],
        recommendedActions: [],
      },
    ],
    ...
    architectureModel: {
      ...
      sourceRef: 'docs/architecture/decisions/adr-archive.md',
