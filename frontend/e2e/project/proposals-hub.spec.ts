...
async function routes(page: Page): Promise<void> {
  ...
  await page.route('**/api/projects/Proposal%20Demo/proposals', route => route.fulfill({ status: 200, contentType: 'application/json', body: JSON.stringify({ items: [
    { id: 'survey-001', generation: '2026-07-11', finding: 'The project navigation collapses at narrow widths and hides the operator decision context.', evidenceScreenshot: '2026-07-11/assets/001.png', proposal: 'Keep the navigation and decision controls visible at narrow widths.', estimatedEffort: 'medium', severity: 'critical', status: 'proposed', spawnedTask: null, relPath: '2026-07-11/survey-001.md', updatedAt: '2026-07-11T08:00:00Z' },
    { id: 'survey-002', generation: '2026-07-11', finding: 'The settings view lacks a concise summary before its long form.', evidenceScreenshot: '2026-07-11/assets/002.png', proposal: 'Add a compact settings summary with direct links to the affected sections.', estimatedEffort: 'small', severity: 'medium', status: 'proposed', spawnedTask: null, relPath: '2026-07-11/survey-002.md', updatedAt: '2026-07-11T08:00:00Z' },
    { id: 'survey-003', generation: '2026-06-18', finding: 'A prior generation item has already been implemented.', evidenceScreenshot: '2026-06-18/assets/003.png', proposal: 'Group the visual evidence by project surface.', estimatedEffort: 'medium', severity: 'medium', status: 'spawned', spawnedTask: null, relPath: '2026-06-18/survey-003.md', updatedAt: '2026-07-01T08:00:00Z' },
  ] }) }));
  await page.route('**/api/projects/Proposal%20Demo/proposals/evidence/**', route => route.fulfill({ status: 200, contentType: 'image/png', body: evidence }));
}
